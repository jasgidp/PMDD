...
| Referencias | Equipo | borrador catálogo | ver `05_FUENTES.md` | [@Ceret2013] | Fuentes AR/enfoques |

## PPT (versionada en `/contexto/`)

| Artefacto | Archivo | Estado | Qué falta |
|-----------|---------|--------|-----------|
| Socialización (40%) | `PPT_SOCIALIZACION.md` | esqueleto | Contenido de diapositivas |
| PPT corregida (anexa al 60%) | `PPT_CORREGIDA.md` | pendiente | Feedback de clase |
